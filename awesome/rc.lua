...
globalkeys = mytable.join(
    ...
    -- Take a fast screenshot
    awful.key({ modkey }, "p", function() awful.spawn.with_shell("flameshot full -p ~/Images/screenshots -d 0") end,
              {description = "take a fast screenshot", group = "hotkeys"}),
